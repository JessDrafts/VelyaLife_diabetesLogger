...
\begin{document}
    ...
    The current version is an upgrade from the initial application. This documentation will cover only the latest version. If you're interested in the project's original documentation, click here: \href{https://github.com/JessDrafts/VelyaLife_diabetes_logger/blob/1ab52b40225fa5d191403c55fefa9305ff35b08b/RELAZIONE%20INGEGNERIA%20DEL%20SOFTWARE_V1.pdf}{\textit{’Relazione Ingegneria del software’}}.
