...
\begin{document}
    ...
    The current version is an upgrade from the initial application. This documentation will cover only the latest version. If you're interested in the project's original documentation, click here: \href{https://github.com/JessDrafts/VelyaLife_diabetesLogger/blob/8e41f58e0bbccc49eea5d41ba4e14d7d9b7a9045/documentation/RELAZIONE%20INGEGNERIA%20DEL%20SOFTWARE_V1.pdf}{\textit{’Relazione Ingegneria del software’}}.
